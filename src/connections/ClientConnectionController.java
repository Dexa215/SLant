...
//------------------------------------------------------------------------
	 ...
	 * @param me riferimento al Client che genera il ccc, necessario per spedire a questo comandi ed ottenere dati
	 * memorizzati da piu classi ( ad esempio le GUI ) sul client
	 */
