...
* @throws InterruptedException eccezione inerente ad interrupted sql
	...
	/**considera in base ai contatori se prendere dalla coda un comando da eseguire o passare al successivo controllo [AL]
	 * @throws InterruptedException eccezione inerente ad interrupted sql
 	 */		
	 ...
	 * @param cs	int, Countinuosly Served	int, Countinuosly Served
	 * @throws InterruptedException eccezione inerente ad interrupted sql
 	 */	
	...
	/**resetta contatori delle altre code, prende dalla coda un messageserver contenente comando da eseguire
	 * e realserver go da sbloccare
	 * @param cs	int, Countinuosly Served
	 * @throws InterruptedException eccezione inerente ad interrupted sql
	 */
