...
public class ClientCMDloans {
	 ...
	 */
	public static void LoansNew(Client me) throws  SQLException, InterruptedException{	
		String mSg;
	 ...
	 * @throws InterruptedException eccezione inerente ad interrupted sql
	 */
	public static void LoansReturned(Client me) throws  SQLException, InterruptedException{	
		String mSg;
	 ...
	 * @throws InterruptedException eccezione inerente ad interrupted sql
	 */
	public static void LoansRetired(Client me) throws  SQLException, InterruptedException{	
		String mSg;
	 ...
	 * @throws InterruptedException eccezione inerente ad interrupted sql
	 */
	public static void LoansDELETE(Client me) throws  SQLException, InterruptedException{	
		String mSg;
	 ...
	 * @throws InterruptedException eccezione inerente ad interrupted sql
	 */
	public static void Loanspopulate(Client me) throws  SQLException, InterruptedException {
		String mSg;
