...
public class Client implements Serializable, Runnable  {
	...
	private 			String				ipaddLocal="127.0.0.1";
...
//------------------------------------------------------------------------
		/**
		 * @param 	cmd comando da enumerativa commands
		 * @return	MessageBack ottenuto da server
		 * @throws 	IOException  eccezione dovuta alla comunicazione stub / skeleton
		 */
	...
	/**
	 * @return mSgBack ottenuto da connTEST
	 */
	...
	/**
	 * @return mSgBack ottenuto da connSTOP
	 */
...
//!!!! --------------------------										
	...
	/**
	 * @param MsgSend 	messaggio spedito al server					
	 * @param Mb 		messaggi ritornato dal server		
	 * @throws SQLException eccezione  inerente operazioni sql
	 * @throws InterruptedException eccezione inerente ad interrupted sql
	 */
	public void sendM(Message MsgSend,MessageBack Mb) throws  SQLException, InterruptedException{
			try {
						System.out.println("CLI :> spedisco a STUB comando: "+MsgSend.getCmd());	
						Mb = this.getSrv().SendRequest(MsgSend);	// SPEDISCE AL SRV [STUB] MESSAGE contenente COMMAND																
...
//	
	 ...
	 * @throws InterruptedException eccezione inerente ad interrupted sql
	 */
	private void ClientCheckExistDB() throws SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientCheckExistTableSetting() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientCheckExistTableBooking() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientCheckExistTableBook() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientCheckExistTablePerson() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientCheckExistTableLoans() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientCHANGEuserRegistration() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void BookLast () throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void BookPopulate () throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientBookAdd() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void ClientBookDelete() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserREADcheckCfExist() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserREADcheckEmailExist() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserGetData() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserGetDatabyEmail() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserGetDatabyEmailAcc() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserGetDatabyEmailMod() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserGetDataLogin() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserGetDataLoginFIRST() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserGetDataAccountMod() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserUPDATE() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void UserDELETE() throws  SQLException, InterruptedException{
		 ...
		 * @throws InterruptedException eccezione inerente ad interrupted sql
		 */
		private void LoanGetData() throws  SQLException, InterruptedException{
		 ...
		 * @param t stringa da inserire nel campo testo predefinito della gui 
		 */
