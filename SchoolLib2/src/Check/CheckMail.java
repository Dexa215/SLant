...
public class CheckMail {
	...
	//TODO DA TESTARE DA LOGIN
		 ...
		 * @param me Client
		 * @param txtMail stringa dell'email
		 * @param txtMailMod  stringa dell'email modificata
		 * @param ActF JFRAME
		 * @param ActW Window
		 * @param ActC Window Corrente
		 * @return checkok se l'email immessa è corretta
		 */
     ...
     * @param ActW Window
	 * @param ActC Window Corrente
	 * @return checkok se l'email è corretta del panel modify
	 */
	 ...
	 * @param ActW Window
	 * @param ActC  Window Corrente
	 * @return checkok se l'email è corretta, panel Appreader(lettore)
	 */
